...
date: 2026-04-03 12:00 +08:00
tags: [AI, Skill, MCP, Cursor, Codex, 工具链]
description: "以「小黑屋」比喻说明：MCP 为大模型提供标准化的外部连接，让模型从封闭推理走向读写文件、终端与服务等真实能力；Skill 则解决「接得上」之后如何理解工具、掌握手法与沉淀领域经验，尤其对小众库与垂直场景至关重要。文中辨析 Skill 与长提示词、固定工作流的差别，梳理 MCP 与 Skill 的分工互补，并讨论按需加载与经验注入为何让 Skill 在落地应用中越来越关键。"
comments: true
---
